...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog "$QSYS_SIMDIR/submodules/clocksystem_up_clocks_0.v"   -work up_clocks_0    -cdslib ./cds_libs/up_clocks_0.cds.lib   
  ncvlog "$QSYS_SIMDIR/clocksystem.v"                                                                                        
fi
