...
# ACDS 13.0sp1 232 linux 2019.03.09.20:35:52
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "clocksystem"
} 
...
alias com {
  ...
  vlog "$QSYS_SIMDIR/submodules/clocksystem_up_clocks_0.v"   -work up_clocks_0   
  vlog "$QSYS_SIMDIR/clocksystem.v"                                              
}
...
alias elab {
  echo "\[exec\] elab"
  vsim -t ps -L work -L work_lib -L rst_controller -L up_clocks_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneii_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  vsim -novopt -t ps -L work -L work_lib -L rst_controller -L up_clocks_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneii_ver $TOP_LEVEL_NAME
}
